...
class CustomSummaryWriter(SummaryWriter):
    ...
    def add_images(self, name, images, iteration, boxes_infer=None, boxes_gt= None, labels=None, resize=None, match=None):
        ...
        if boxes_infer is not None:
            ...
            if match==None:
                images = self.draw_boxes_on_images(images, boxes_infer, labels, no_match=True)
    ...
    def draw_boxes_on_images(self, images, boxes, labels=None, match=None, no_match=False):
        ...
        for i in range(images.shape[0]):
            ...
            for j in range(boxes.shape[1]):
                ...
                if match is not None:
                    ...
                    draw.rectangle(kp, outline=color, fill=None, width=3)
